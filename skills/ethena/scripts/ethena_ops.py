...
def cooldown_calldata(amount_wei: int) -> dict:
    ...
    # cooldownAssets(uint256) = 0xf3fef3a3 — note: verify selector
    # Actually: cooldownAssets(uint256)
    # keccak256("cooldownAssets(uint256)")[:4]
    selector = "02b1e7a9"  # Verified from Etherscan
...
def unstake_calldata(receiver: str) -> dict:
    ...
    # unstake(address)
    selector = "2f2ff15d"  # Placeholder — verify from contract ABI
